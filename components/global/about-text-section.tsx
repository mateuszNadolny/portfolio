    ...
    >
      ...
      <p className="leading-7 text-neutral-400 mb-10 tracking-tight">
        ...
        <b className="decoration-green-900 underline underline-offset-4 tracking-tight">
          I am deeply passionate about creating conversion-focused websites that
          help businesses grow
        </b>
        . I enjoy bridging the gap between design, development, and marketing by
        leveraging data-driven strategies to enhance user experience and drive
        measurable results.
      </p>
      <p className="leading-7 text-neutral-400 mb-10 tracking-tight">
        I am constantly expanding my knowledge of web technologies, SaaS trends,
        and marketing strategies. Whether it is refining the art of crafting
        user-friendly interfaces or optimizing a site for better conversion
        rates,{" "}
        <b className="decoration-green-900 underline underline-offset-4">
